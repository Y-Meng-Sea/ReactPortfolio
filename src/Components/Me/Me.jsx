      ...
      <div className="row">
        <div className="col-md-7 d-flex align-items-center justify-content-center">
          <p className="px-5 lh-lg">
            ...
            thankfully i can understand a little bit of English so decided to study by my self and i built about 5 basic website and of course my
            first website look weird {<BsEmojiWink style={{ color: "#FFC83D" }} />} , at least i can built this portfolio website using React JS which
            is the newest skill i have gain, i tell you one more thing i failed English subject {<BsEmojiGrin style={{ color: "#FFC83D" }} />} .
          </p>
        </div>
