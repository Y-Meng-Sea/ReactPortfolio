            ...
            <div className="container timelinecontainer py-3">
              <div className="container content">
                <div className="py-2 px-3">
                  ...
                  <p>bachelor's degree of Information Technology Department</p>
                  <p>GPA 3.5</p>
                </div>
              </div>
            </div>
            ...
            {/* <div className="container timelinecontainer py-3">
              <div className="container content">
                <div className="py-2 px-3">
                  ...
                  <p>I also use to train and work as an Intership with a startup company but i resign due to bad situation</p>
